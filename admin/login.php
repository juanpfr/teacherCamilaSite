                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <form class="mb-md-5 mt-md-4 pb-5 site" id="formLoginAdmin">
                                ...
                                <div data-mdb-input-init class="form-outline form-white mb-4">
                                    ...
                                    <br>
                                    <input name="senha" type="password" id="typePasswordX" class="form-control form-control-lg" />
                                </div>
                                <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#!">Esqueceu sua senha?</a></p>
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5" type="button" onclick="LoginAdmin()">Login</button>
                            </form>
                            <div>
                                <p class="mb-0">Não tem conta? <a href="#!" class="text-white-50 fw-bold">Cadastre-se</a></p>
                            </div>
